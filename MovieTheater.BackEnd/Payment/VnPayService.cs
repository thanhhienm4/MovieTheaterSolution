...
namespace MovieTheater.BackEnd.Payment
{
    public class VnPayService
    {
        ...
        public string CreateRequest(UserVMD user)
        {
            ...
            //Save order to db
            order.OrderId = 12313213; // Giả lập mã giao dịch hệ thống merchant gửi sang VNPAY
            ...
            vnpay.AddRequestData("vnp_Inv_Customer", user.UserName);
