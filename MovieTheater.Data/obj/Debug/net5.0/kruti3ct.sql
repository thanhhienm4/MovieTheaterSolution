...
CREATE TABLE [Tickets] (
    ...
    CONSTRAINT [FK_Tickets_Reservations_ReservationId] FOREIGN KEY ([ReservationId]) REFERENCES [Reservations] ([Id]) ON DELETE NO ACTION,
...
VALUES (N'20210313023930_1', N'5.0.4');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210313024127_2', N'5.0.4');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210313024751_3', N'5.0.4');
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210313045041_4', N'5.0.4');
GO
