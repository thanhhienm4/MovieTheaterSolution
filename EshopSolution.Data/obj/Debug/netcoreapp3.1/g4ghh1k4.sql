...
ALTER TABLE [Products] ADD [ThumnailImageID] int NOT NULL DEFAULT 0;

GO

ALTER TABLE [ProductImages] ADD [ProductThumnailId] int NOT NULL DEFAULT 0;

GO

UPDATE [AppRoles] SET [ConcurrencyStamp] = N'5b661a64-0c2b-4720-89aa-f5c3428d88b0'
WHERE [Id] = '8d04dce2-969a-435d-bba4-df3f325983dc';
SELECT @@ROWCOUNT;
...
UPDATE [AppUsers] SET [PasswordHash] = N'AQAAAAEAACcQAAAAELg8AF4Apl0vH/MWq7X6NMm/9w7fBStLZdbiJ+2+ppXPjDvRULOQthqyRcYbvxalyQ=='
WHERE [Id] = '69bd714f-9576-45ba-b5b7-f00649be00de';
SELECT @@ROWCOUNT;
...
UPDATE [Products] SET [DateCreated] = '2021-02-03T14:02:05.3411478+07:00'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
CREATE UNIQUE INDEX [IX_Products_ThumnailImageID] ON [Products] ([ThumnailImageID]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210203070207_test1', N'5.0.0-preview.7.20365.15');

GO

DROP INDEX [IX_Products_ThumnailImageID] ON [Products];
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[ProductImages]') AND [c].[name] = N'ProductThumnailId');
IF @var7 IS NOT NULL EXEC(N'ALTER TABLE [ProductImages] DROP CONSTRAINT [' + @var7 + '];');
ALTER TABLE [ProductImages] DROP COLUMN [ProductThumnailId];

GO

UPDATE [AppRoles] SET [ConcurrencyStamp] = N'247a6c9d-fc77-4d58-aa39-e594e2bf4f3e'
WHERE [Id] = '8d04dce2-969a-435d-bba4-df3f325983dc';
SELECT @@ROWCOUNT;
...
UPDATE [AppUsers] SET [PasswordHash] = N'AQAAAAEAACcQAAAAEB3fKLF4OL3eYepLgDuCctAEjKe/DvrnHls9UsYZBXJMRV73Auah4pPW0mtMOffOOA=='
WHERE [Id] = '69bd714f-9576-45ba-b5b7-f00649be00de';
SELECT @@ROWCOUNT;
...
UPDATE [Products] SET [DateCreated] = '2021-02-03T22:38:47.9858333+07:00'
WHERE [Id] = 1;
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20210203153850_test2', N'5.0.0-preview.7.20365.15');
