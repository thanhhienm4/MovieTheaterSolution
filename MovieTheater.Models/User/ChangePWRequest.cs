...
namespace MovieTheater.Models.User
{
    public class ChangePwRequest
    {
        ...
        [Display(Name = "Mật khẩu")] public string OldPassword { get; set; }
    ...
    public class ChangePwRequestValidator : AbstractValidator<ChangePwRequest>
    {
        public ChangePwRequestValidator()
        {
            ...
            RuleFor(x => x.NewPassword).Equal(x => x.NewConfirmPassword)
                .When(customer => !String.IsNullOrWhiteSpace(customer.NewPassword)).WithMessage("Mật khẩu không khớp");
        }
    }
}